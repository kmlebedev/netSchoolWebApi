...
namespace IO.Swagger.Model
{
        ...
        public partial class LoginData :  IEquatable<LoginData>, IValidatableObject
    {
        ...
        public LoginData(string productName = default(string), string version = default(string), string esiaLoginPage = default(string), string cacheVer = default(string), bool? schoolLogin = default(bool?), bool? emLogin = default(bool?), bool? windowsAuth = default(bool?), bool? enableSms = default(bool?), bool? esiaMainAuth = default(bool?), bool? esiaButton = default(bool?), bool? signatureLogin = default(bool?))
        {
