...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DiaryAssignDetailsAttachments', function() {
      beforeEach(function() {
        instance = new NetSchool.DiaryAssignDetailsAttachments();
      });

      it('should create an instance of DiaryAssignDetailsAttachments', function() {
        // TODO: update the code to test DiaryAssignDetailsAttachments
        expect(instance).to.be.a(NetSchool.DiaryAssignDetailsAttachments);
      });
