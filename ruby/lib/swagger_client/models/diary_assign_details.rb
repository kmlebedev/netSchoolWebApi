...
module SwaggerClient
  class DiaryAssignDetails
    ...
    attr_accessor :code_content_elements
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DiaryAssignDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DiaryAssignDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'activity_name')
        self.activity_name = attributes[:'activity_name']
      end

      if attributes.key?(:'problem_name')
        self.problem_name = attributes[:'problem_name']
      end

      if attributes.key?(:'subject_group')
      ...
      if attributes.key?(:'content_elements')
        if (value = attributes[:'content_elements']).is_a?(Array)
          self.content_elements = value
        end
      end

      if attributes.key?(:'code_content_elements')
        if (value = attributes[:'code_content_elements']).is_a?(Array)
          self.code_content_elements = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          content_elements == o.content_elements &&
          code_content_elements == o.code_content_elements
    end
